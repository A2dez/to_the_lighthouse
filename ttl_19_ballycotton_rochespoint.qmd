...
-   add more about knockadoon with family
...
The beach that in Garryvoe has tracked me all the way to Ballycotton where I'm met by a wedge-shaped village on a rock, with houses painted in garish slabs of colour that harmonise somewhat to brighten up this rain-sodden island of greygreen misery. A small crowd gawk at me from a cafe which has squatted an old church. A number of gastrojuicers bounce out of the long, narrow main street where moving cars take turns to jostle past parked ones, while pedestrian families must wend through any gaps, like roadspace scavengers. Eventually the road forks and one road leads to the little harbour down below. Along the pier is the office for the lighthouse tours, but as closed. It's what I expected but I'm still disappointed and it'll be some time before I can get back. At the far end of the pier, a car blasts out some crap rap and five topless lads sit up high on the pier wall, screaming to be heard above the beats. I'm tempted to interrupt their buzz, just for shits'n'giggz, but instead I stall it back up the near end of the pier to admire the view and take photos of the lighthouse.

andBut it is on the second of the islands so I need t

a few football-pitches of low-tide rocks lie between here and the delicioso island lighthouse.

The tide is out and it looks like you could walk across the low-tide rocks to the lovely lighthouses. But it turns out that the low rocks ocnnec

the low rocks connect the mainland to the flat inner island. From here you can't actually see the water separating it from the Christmas Pudding Outer Island, only a few football fields away, with its curious black tower on top. At first the families lived on the island with the on-duty lighthouse keeper, but later the families moved to the village and the keeper would do a fortnight of duty on his Marcel. The family could wave across or send semaphore messages using flags. I suspect that they may have used this method to keep track of live sports scores. Up with the flags whenever a goal or point is scored. Like following matches sport on Aertel or Ceefax twenty or thirty years ago, when you'd repeatedly refresh the page to see if Robbie Fowler had scored another. It'd be a tough task to track modern hurling though. Puck, puck, score.
...
-   i'll remember htis person

-   coffee before train

-   there in 5

-   two social things back to back

-   free subscritip

-   tabs open

-   30 mins enough time to get ready, laundry
